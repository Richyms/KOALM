...
class MeditationTimerService : Service() {
    companion object {
        private const val CHANNEL_ID = "meditacion_timer"
        private const val NOTIFICATION_ID = 202
        private const val TAG = "KOALM_MEDITATION_TIMER"
        const val TIMER_ACTION = "com.example.koalm.MEDITATION_TIMER_ACTION"
        const val START_TIMER_ACTION = "com.example.koalm.START_MEDITATION_TIMER_ACTION"
        const val TIMER_UPDATE_ACTION = "com.example.koalm.MEDITATION_TIMER_UPDATE_ACTION"
        const val CHECK_TIMER_ACTION = "com.example.koalm.CHECK_MEDITATION_TIMER_ACTION"
    ...
    override fun onCreate() {
        super.onCreate()
        Log.e(TAG, "onCreate: Servicio de temporizador de meditación creado")
        createNotificationChannel()
    }

    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.e(TAG, "onStartCommand: Iniciando servicio de temporizador de meditación")
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = getString(R.string.meditation_timer_channel_name)
            val descriptionText = getString(R.string.meditation_timer_channel_description)
    ...
    private fun createNotification(): android.app.Notification {
        ...
        try {
            ...
            val notificationTitle = getString(R.string.meditation_timer_notification_title)
            ...
            val notification = NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .addAction(
                    ...
                    getString(R.string.historial_meditacion),
    ...
    private fun startTimer() {
        Log.e(TAG, "startTimer: Iniciando temporizador de meditación de $durationMinutes minutos")
        ...
        timer = object : CountDownTimer(durationMinutes * 60 * 1000, 1000) {
            ...
            override fun onFinish() {
                Log.e(TAG, "onFinish: Temporizador de meditación finalizado")
    ...
    private fun showCompletionNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val completionChannelId = "meditation_completion_channel"
            val name = "Finalización del temporizador de meditación"
            val descriptionText = "Canal para notificaciones de finalización del temporizador de meditación"
            ...
            val completionTitle = getString(R.string.meditation_timer_completion_title)
            val completionText = getString(R.string.meditation_timer_completion_text)
